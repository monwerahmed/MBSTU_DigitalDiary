...
public class Sonali_bank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sonali_bank);
        db1 = FirebaseDatabase.getInstance().getReference("Sonali Bank");
        listView = findViewById(R.id.listviewsonali);

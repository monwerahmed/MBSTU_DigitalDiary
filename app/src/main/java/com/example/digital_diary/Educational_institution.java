...
public class Educational_institution extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational_institution);
        FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        db1 = FirebaseDatabase.getInstance().getReference("Educational Institution");
        listView = findViewById(R.id.listviewedu);

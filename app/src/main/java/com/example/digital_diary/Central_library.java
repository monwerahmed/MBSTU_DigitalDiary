...
public class Central_library extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db1 = FirebaseDatabase.getInstance().getReference("Central Library");
        listView = findViewById(R.id.listviewcetra);
